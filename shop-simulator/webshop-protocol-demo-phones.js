...
export function scenario_1() {
  ...
  group(`page_2 - http://${__ENV.HOSTNAME}:3389/shop?product=XIAOMI&name=${users[vu.idInTest -1].username}`, function () {
    response = http.post(
      `http://${__ENV.HOSTNAME}:3389/shop?product=XIAOMI&name=${users[vu.idInTest -1].username}`,
      {
        product: `XIAOMI`,
      },
      {
  ...
  group(`page_4 - http://${__ENV.HOSTNAME}:3389/shop?product=SAMSUNG&name=${users[vu.idInTest -1].username}`, function () {
    response = http.post(
      `http://${__ENV.HOSTNAME}:3389/shop?product=SAMSUNG&name=${users[vu.idInTest -1].username}`,
      {
        product: 'SAMSUNG',
      },
      {
  ...
  group(`page_7 - http://${__ENV.HOSTNAME}:3389/shop?product=OPPO&name=${users[vu.idInTest -1].username}`, function () {
    response = http.post(
      `http://${__ENV.HOSTNAME}:3389/shop?product=OPPO&name=${users[vu.idInTest -1].username}`,
      {
        product: 'OPPO',
      },
      {
  ...
  group(`page_8 - http://${__ENV.HOSTNAME}:3389/shop?product=ZTE&name=${users[vu.idInTest -1].username}`, function () {
    response = http.post(
      `http://${__ENV.HOSTNAME}:3389/shop?product=ZTE&name=${users[vu.idInTest -1].username}`,
      {
        product: 'ZTE',
      },
      {
  ...
  group(`page_9 - http://${__ENV.HOSTNAME}:3389/shop?product=SAMSUNG&name=${users[vu.idInTest -1].username}`, function () {
    response = http.post(
      `http://${__ENV.HOSTNAME}:3389/shop?product=SAMSUNG&name=${users[vu.idInTest -1].username}`,
      {
        product: 'SAMSUNG',
  ...
  group(`page_11a - http://${__ENV.HOSTNAME}:3389/shop?product=SAMSUNG&name=${users[vu.idInTest -1].username}`, function () {
    response = http.post(
